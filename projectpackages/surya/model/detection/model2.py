...
def load_model2(checkpoint=settings2.DETECTOR_MODEL_CHECKPOINT, device=settings2.TORCH_DEVICE_MODEL, dtype=settings2.MODEL_DTYPE):
...
def load_processor2(checkpoint=settings2.DETECTOR_MODEL_CHECKPOINT):
